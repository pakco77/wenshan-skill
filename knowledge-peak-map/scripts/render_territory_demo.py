...
<article class="poster" id="poster"><header class="head"><div><div class="wordmark" id="wordmark">文山.skill</div><p class="slogan" id="slogan"></p></div><div class="profile"><strong id="nickname"></strong><span class="meta" id="meta"></span></div></header><section class="map-shell"><canvas id="map" width="900" height="1200" aria-label="知识山峰地图"></canvas><aside class="inspector" id="inspector" aria-live="polite"></aside><small class="timestamp" id="timestamp"></small></section></article>
